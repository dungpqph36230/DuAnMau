...
public class LoginActivity extends AppCompatActivity {
    ...
    public void taoDuLieuNhanVien() {
        ...
        db.themNhanVien(new NhanVien("admin", "Nguyễn Văn An", "12 Lý Tự Trọng, Q1, TP.HCM", 1, 25000000, "admin"));
        db.themNhanVien(new NhanVien("NV001", "Trần Thị Cúc", "34 Lê Lợi, Q3, TP.HCM", 0, 12000000, "nv001"));
        db.themNhanVien(new NhanVien("NV002", "Trần Thị Hồng", "36 Lê Lợi, Q3, TP.HCM", 0, 12000000, "sales456"));
